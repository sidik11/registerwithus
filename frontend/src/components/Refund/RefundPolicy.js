  ...
  return (
    <section className="refund-policy text-white py-5">
      <div className="container">
       <h3 class="icon-color text-center mb-4"><i class="fas fa-undo-alt me-2"></i>Refund Understanding</h3>
        ...
        <h3 class="icon-color text-center mb-4"><i class="fas fa-undo-alt me-2 mt-4"></i>Cooling-Off Period (Full Refund)</h3>
        <div className="refund-box p-4 rounded">
        ...
        <h3 class="icon-color text-center mb-4"><i class="fas fa-ban me-2 mt-4"></i>Non-Refundable Elements</h3>
        <div className="refund-box p-4 rounded">
        ...
        <h3 class="icon-color text-center mb-4"><i class="fas fa-coins me-2 mt-4"></i>Partial Refunds</h3>
        <div className="refund-box p-4 rounded">
        ...
        <h3 class="icon-color text-center mb-4"><i class="fas fa-file-alt me-2 mt-4"></i>How to Request for Refund</h3>
        <div className="refund-box p-4 rounded">
          <ul>
        ...
        <h3 class="icon-color text-center mb-4"><i class="fas fa-arrow-up me-2 mt-4"></i>Escalation</h3>
        <div className="refund-box p-4 rounded">
          <ul>
