                ...
                <div className="container h-100">
                    <div className="row align-items-center h-100">
                        ...
                        <div className="col-lg-7 text-white about-hero-content">
                            ...
                            <p className="fs-5">
                                We value your privacy and are committed to protecting your personal data. Any information you share with us is handled securely and used only to enhance your experience with our services. We never sell or share your data with third parties without your consent. Read our full privacy policy for details.
                            </p>
                            <a href="#" className="btn cta-btn-glass">
                                <i className="fa-solid fa-phone me-2"></i>Call Now <i className="fa-solid fa-arrow-right ms-2"></i>
                            </a>
